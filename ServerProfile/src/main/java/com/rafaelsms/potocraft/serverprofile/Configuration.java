...
public class Configuration extends YamlFile {
    ...
    public Integer getSavePlayersTaskTimerTicks() {
        return getIntOrThrow("configuration.save_players_task_timer_in_ticks");
    }

    public Double getLocalChatRange() {
        return getDoubleOrThrow("configuration.local_chat.range");
    }
    ...
    public Integer getTeleportDelayTicks() {
        return getIntOrThrow("configuration.teleport.teleport_delay_in_ticks");
    }

    public Duration getTeleportCooldown() {
        return Duration.ofSeconds(Objects.requireNonNull(getLongOrThrow("configuration.teleport.teleport_cooldown_in_seconds")));
    }

    public Duration getTeleportRequestDuration() {
        return Duration.ofSeconds(Objects.requireNonNull(getLongOrThrow(
                "configuration.teleport.teleport_request_duration_in_seconds")));
    }

    public Duration getTotemCooldown() {
        return Duration.ofSeconds(Objects.requireNonNull(getLongOrThrow("configuration.totem_usage_cooldown_in_seconds")));
    }

    public Integer getDefaultHomeNumber() {
        return getIntOrThrow("configuration.homes.default_number_of_homes");
    }

    public Long getHomeReplacementTimeout() {
        return getLongOrThrow("configuration.homes.replace_home_timeout_ticks");
    }
    ...
    public Integer getMobCombatDurationTicks() {
        return getIntOrThrow("configuration.combat.mob_combat_duration_ticks");
    }

    public Integer getPlayerCombatDurationTicks() {
        return getIntOrThrow("configuration.combat.player_combat_duration_ticks");
    }
    ...
    public Duration getPlayerKillerTimeout() {
        return Duration.ofSeconds(Objects.requireNonNull(getIntOrThrow("configuration.combat.player_killer_time_seconds")));
    }
    ...
    public Long getHardcoreDefaultBanTime() {
        return getLongOrThrow("configuration.combat.hardcore.default_ban_time_in_seconds");
    }
    ...
    public Component getTeleportRequestSent(@NotNull String username) {
        return TextUtil.toComponent(getOrThrow("language.teleport.requests.sent"), Placeholder.parsed("username", username));
    }
