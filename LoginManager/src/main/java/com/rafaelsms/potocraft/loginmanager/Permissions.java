...
public final class Permissions {
    ...
    public static final String HIDDEN_ON_PLAYER_LIST = "potocraft.proxy.player_list_hidden";
    ...
    public static final String COMMAND_TEMPORARY_BAN = "potocraft.command.tempban";
    public static final String COMMAND_TEMPORARY_BAN_OFFLINE = "potocraft.command.tempban.offline";
