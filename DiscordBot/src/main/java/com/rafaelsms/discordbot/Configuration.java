...
public class Configuration extends YamlFile {
    ...
    public Duration getRemovedMessagesCacheTime() {
        return Duration.ofSeconds(Objects.requireNonNull(getLongOrThrow("configuration.removed_messages.cached_time_in_seconds")));
    }
    ...
    public int getMaximumMessageLength() {
        return Objects.requireNonNull(getIntOrThrow("configuration.message_length_limiter.maximum_length"));
    }

    public int getMaximumNewLines() {
        return Objects.requireNonNull(getIntOrThrow("configuration.message_length_limiter.maximum_new_line_count"));
    }

    public int getMaximumEmojiCount() {
        return Objects.requireNonNull(getIntOrThrow("configuration.message_length_limiter.maximum_emoji_count"));
    }
    ...
    public Duration getMentionsWarningDuration() {
        return Duration.ofSeconds(Objects.requireNonNull(getLongOrThrow("configuration.mentions.warn_message_duration_seconds")));
    }

    public Duration getMentioningTimeout() {
        return Duration.ofSeconds(Objects.requireNonNull(getLongOrThrow("configuration.mentions.user_timeout_seconds")));
    }
    ...
    public Duration getCursedTimeout() {
        return Duration.ofSeconds(Objects.requireNonNull(getLongOrThrow("configuration.blocked_words.user_timeout_seconds")));
    }
